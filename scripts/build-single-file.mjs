...
const sourceFiles = {
  ...
  scripts: [
    ...
    path.join(root, "src", "scripts", "platform", "utils.js"),
    path.join(root, "src", "scripts", "platform", "sfx.js"),
    path.join(root, "src", "scripts", "platform", "game-shell.js"),
    ...
    path.join(root, "src", "scripts", "games", "vocab-scene.js"),
    path.join(root, "src", "scripts", "games", "reading-scene.js"),
    path.join(root, "src", "scripts", "games", "grammar-scene.js"),
    path.join(root, "src", "scripts", "games", "rhyme-scene.js"),
    ...
    path.join(root, "src", "scripts", "games", "placeval-scene.js"),
    path.join(root, "src", "scripts", "games", "telltime-scene.js"),
    path.join(root, "src", "scripts", "games", "money-scene.js"),
    path.join(root, "src", "scripts", "games", "fractions-scene.js"),
    path.join(root, "src", "scripts", "games", "wordprob-scene.js"),
    path.join(root, "src", "scripts", "games", "shapes-scene.js"),
    path.join(root, "src", "scripts", "games", "datahandling-scene.js"),
    path.join(root, "src", "scripts", "games", "measure-scene.js"),
    path.join(root, "src", "scripts", "games", "sequence-scene.js"),
    path.join(root, "src", "scripts", "games", "capitals-scene.js"),
    path.join(root, "src", "scripts", "games", "continents-scene.js"),
    path.join(root, "src", "scripts", "games", "weather-scene.js"),
    path.join(root, "src", "scripts", "games", "compass-scene.js"),
    path.join(root, "src", "scripts", "games", "flags-scene.js"),
    path.join(root, "src", "scripts", "games", "spellbound-forest.js"),
    path.join(root, "src", "scripts", "games", "number-forge.js"),
    path.join(root, "src", "scripts", "games", "spelling-platformer.js"),
